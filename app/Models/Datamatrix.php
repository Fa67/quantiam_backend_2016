...
{
    //
	function create_datamatrix ($print, $string)
		
		{
		
							$return_array['input'] = get_defined_vars();
							...
							$web_path = "http://apps.edm.quantiam.com/assets/data_matrix/".$string.".jpg";
							$local_path = "C:/inetpub/wwwroot/Quantiam/assets/data_matrix/".$string.".jpg";
							  ...
							  $width    = 12;    // barcode height in 1D ; not use in 2D
							  $angle    = 0;   // rotation in degrees : nb : non horizontable barcode might not be usable because of pixelisation
							  
							  $code     = 'QMSI-2132'; // barcode, of course ;)
							  $type     = 'datamatrix';
							  ...
							  if ( isset($font) ){
								...
								imagettftext($im, $fontSize, $angle, $x + $xt, $y + $yt, $white, $font, $data['hri']);
							  ...
							  // -------------------------------------------------- //
								...
								imagejpeg ($im, $local_path);
										
							  imagedestroy($im);	
								$return_array['output']['status'] = 'Datamatrix Created';
							  }
							  else
							  {
								  $return_array['output']['status'] = 'Datamatrix already exists. ';
								 }
							  
							  
								$return_array['output']['html'] = '<img src ="'.$web_path.'"></img>';
								$return_array['output']['web_url'] = $web_path;
								$return_array['output']['value'] = $string;
